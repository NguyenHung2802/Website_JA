...
<div class="home">
    <div class="container">
        <div class="home_slide">
            <div class="home_slide-intro">
                <p>Mỹ phẩm trị liệu hàng đầu Hy Lạp</p>
                <svg class="home_slide-img" viewBox="0 0 27.87 23.76">
