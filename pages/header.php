    ...
    <nav class="header_nav hidden-sm hidden-xs">
        <div class="container">
            <ul class="header_nav-list nav">
                ...
                <li class="header_nav-list-item"><a href="index.php?quanly=trilieu" class="<?php echo isset($_GET['quanly']) && $_GET['quanly'] == 'trilieu' ? 'active' : '' ?>">Trị Liệu</a></li>
                ...
                <li class="header_nav-list-item"><a href="index.php?quanly=kienthuc" class="<?php echo isset($_GET['quanly']) && $_GET['quanly'] == 'kienthuc' ? 'active' : '' ?>">Kiến Thức Sự Kiện</a></li>
                ...
                <li class="header_nav-list-item">
                    <a href="index.php?quanly=news" class="<?php echo isset($_GET['quanly']) && $_GET['quanly'] == 'news' ? 'active' : '' ?>">
