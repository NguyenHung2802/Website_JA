...
<div class="daotao">
    <div class="container">
    <div class="daotao_slide">
            <div class="daotao_slide-intro4">
                <div class="vc_column-inner vc_custom_1616240743835">
                    <div class="wpb_wrapper">
	                    <div class="wpb_text_column wpb_content_element animation bottom-to-top  vc_custom_1618390476122" style="transform: translate(0px, 0px); opacity: 1; visibility: inherit;">
		                    <div class="wpb_wrapper">
			                    <h2 style="text-align: center;"><b>Đào tạo &amp; Chuyển giao phác đồ</b></h2>
                                <p style="text-align: center;"><span style="font-weight: 400;">Các liệu trình trị liệu được chuyển giao qua 2 hình thức: Trực tiếp hoặc Trực tuyến thông qua&nbsp; video ghi hình đào tạo từ Chuyên gia Juliette Armand.</span></p>
        ...
        <div class="daotao_slide2">
            <div class="daotao_slide-intro2">
                <div class="wpb_wrapper">
                    ...
                    <p style="text-align: center;"><span style="color: #57c9e8;"><a class=" more" style="color: #57c9e8;" href="#">Tìm hiểu thêm &gt;</a></span></p>

		        </div>
            </div>
        </div>

        <div class="daotao_slide3">
            <div class="daotao_slide-intro3">
                <div class="wpb_wrapper">
