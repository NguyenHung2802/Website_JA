          ...
          <div class="col-lg-6 col-sm-12 mb-20">
            <div class="card" style="width: 100%;">
              ...
              <div class="card-body">
                ...
                <a href="./ProductDetail.html" title="GIÀY ADIDAS 4D FUTURECRAFT" class="btn btn-buynow">Xem ngay <i class="fas fa-arrow-right" style="font-size: 16px;margin-left: 5px;"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-6 col-sm-12">
            <div class="card" style="width: 100%;">
              ...
              <div class="card-body">
                ...
                <a href="./ProductDetail.html" class="btn btn-buynow">Xem ngay <i class="fas fa-arrow-right " style="font-size: 16px;margin-left: 5px;"></i></a>
              </div>
            </div>
          </div>
        </div>
